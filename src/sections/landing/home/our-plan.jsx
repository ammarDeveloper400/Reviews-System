  ...
  const data = [
    {
      ...
      heading: 'Boost your CX instantly',

    },
    {
      // heading: 'Up to 250,000 tracked visits',
      heading: 'UK based customer support',
    ...
    },
    {
      ...
      heading: 'Complete real time CX feedback',
  ...
  const cardData = [
    {
      ...
      paragraph: (<Typography>Easy anytime instant<br/> cancelation</Typography>),
      heading: 'Boost CX for 3 Months',
    },
    {
      linethrough: '£234',
      box: 'save 30%',
    ...
    },
    {
      ...
      paragraph: (<Typography>Easy anytime instant<br/> cancelation</Typography>),
      heading: 'Boost CX for 12 months',
    },
  ];
  return (
      ...
      <Grid container spacing="38px">
        <Grid item md={4} xs={12}>
          ...
          >
            ...
            {data &&
              data.map((item, index) => (
                <Box display="flex" gap="14px" key={index} mt="22px" alignItems="center">
            ...
            >
              £39<span style={{ fontSize: '30px', color: '#6E6C83' }}>/monthly</span>
            </Typography>
            <Button
              variant="contained"
              fullWidth
