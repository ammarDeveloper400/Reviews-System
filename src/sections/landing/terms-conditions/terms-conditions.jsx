  ...
  return (
    <Box py={{md:'54px', xs:'30px'}} >
      ...
      <Typography fontSize="18px" textAlign="justify">
        ...
        radiomani. Väggord kuligt, till astrokuligen exosk homon, gardinhängarjobb kontism gonnabe,
        krotur kosortad omudosade epiception saleren. Presade laläledes tetrabylogi podys megagen
        dengen. Presade anterade, könade pyning i dylägon vyrat kvasirin för pektigt innan pagen som
        sade dengen uning i källtillit. Prerade mänat spesam och resenade och fafokalig osamma i
        tridona gåde presade. Tegen anime i pseudon pogen, dirade köd därför att disk på sepyssa
        fabås.
      </Typography>
      <br />
