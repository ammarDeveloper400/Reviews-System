...
import { useLazyGetOverallRatingsAndAverageQuery } from 'src/services/store-performance';
import {
...
export default function StaffPerformance() {
  ...
  // for handling total ratings submitted and average score
  ...
  useEffect(() => {
    ...
    getOverallRatingsData({ filterType: formattedRangeValue, rangeValue, storeId: selectedStore })
      .unwrap()
      .then((res) => {
        setOverallRatings(res?.overview);
      });
  }, [rangeValue, selectedStore]);
    ...
    <>
      <Container maxWidth="xl">
        ...
        >
          ...
          <Box display="flex" gap={1.5} flexWrap="wrap">
            {/* <CustomSelect width={260} name="select-staff" label="All Staff" options={[]} /> */}
            <CustomSelect
              name="select-store"
              width={260}
              label="All Stores"
        ...
        {/* {displayType === 'table' ? <TableDisplay /> : <ChartDisplay />} */}
        {displayType === 'table' && (
          <TableDisplay dateRange={dateRange} rangeValue={rangeValue} storeId={selectedStore} />
        )}
        {displayType === 'chart' && (
          <ChartDisplay dateRange={dateRange} rangeValue={rangeValue} storeId={selectedStore} />
        )}
        <Box
          position="fixed"
          bottom={12}
